    ...
    return (
      <View style= {styles.container}>
...

        {
          ...
          <View>
            <ScrollView vertical style={{height:'81%', marginHorizontal:'2%', borderWidth:1, borderColor:'#5caff2', backgroundColor:'white', borderRadius:5}} showsVerticalScrollIndicator={false}
            ...
            {allPaymentRec.map((item,index) => {
              ...
              {
              return(
              <View style= {{flexDirection :'column', width:'100%',height: 100,justifyContent: 'center', alignItems:'center', borderWidth:0.5, borderRadius:5}} key={index}>
        ...
        <View style={{marginTop:'1%', width:'100%', height:'100%'}}>
          <View style={{width:'100%', flexDirection:'row', marginBottom:'1%', marginTop:'1%'}}>
            <View style={{width:'30%', marginHorizontal:'10%'}}>
            <View style={{width:'60%', marginHorizontal:'20%'}}>
              <Button color='#109dcc' title="From" onPress={showDatePicker} />
                <DateTimePickerModal
          ...
          <View>
            <ScrollView vertical style={{height:'74%', marginBottom:'1%',borderWidth:0.5, backgroundColor:'white'}} showsVerticalScrollIndicator={false}
            showsHorizontalScrollIndicator={false}>
