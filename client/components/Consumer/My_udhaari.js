      ...
      <View style= {styles.container}>
...

        {
          ...
          <View style={{marginTop:'1%', width:'100%', height:'100%'}}>
            <View style={{width:'100%', flexDirection:'row', marginBottom:'2%', marginTop:'1%'}}>
          ...
          <View>
            <ScrollView vertical style={{height:'81%', marginHorizontal:'2%', borderWidth:1, borderColor:'#5caff2'}} showsVerticalScrollIndicator={false}
