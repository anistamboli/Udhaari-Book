...
export default function Make_payment() {
  ...
  async function getValueFor() {
    ...
    fetch('https://udhaari.herokuapp.com/threshold/' + vRMN + '/' + cRMN)
  ...
  const updatedata = async (remain) => {
    ...
    try {
      ...
      const response = await fetch('https://udhaari.herokuapp.com/updatedata/' + vRMN + '/' + cRMN, {
        method: 'PUT',
        headers: {
    ...
    if (typeof (amount) === 'string' && typeof (remain) === 'number') {
      ...
      try {
        ...
        if (result.success == true) {
          ...
          const response = await fetch('https://udhaari.herokuapp.com/changedata', {
            method: 'POST',
            headers: {
              'Accept': 'application/json',
              'Content-Type': 'application/JSON'
